...
latex_documents = [
  (
      'index', 'main.tex',
      u'\\django-db-utils Documentation', u'\\Vytautas Astrauskas', 'manual'
      ),
  ]
...
man_pages = [
    (
        'index', 'main',
        u'django-db-utils Documentation', [u'Vytautas Astrauskas'], 1,
        ),
    ]
...
pdf_documents = [
    (
        'index', u'main',
        u'django-db-utils Documentation', u'Vytautas Astrauskas'
        ),
    ]
